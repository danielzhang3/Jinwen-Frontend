    ...
    >
      <div className="max-w-[1100px] mx-auto flex max-[990px]:flex-col min-[1700px]:max-w-[85%] justify-between ">
        <div className="w-[60%] max-[990px]:w-[92%]  max-[500px]:w-full max-[500px]:flex max-[500px]:flex-col max-[990px]:mx-auto ">
          ...
          <p className="font-public-sans  max-[767px]:text-center font-[900] leading-[57px] text-[40px]  mb-7 uppercase text-[#494F53] max-[610px]:text-3xl ">
            Make an Appointment
          </p>
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13721.65733076097!2d76.685208!3d30.7067504!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390feff35b3eba27%3A0x8c87359c9e8547fe!2sSoftRadix%20Technologies%20Pvt%20Ltd-%20Website%20%26%20Mobile%20App%20Development%20Company!5e0!3m2!1sen!2sin!4v1707473089194!5m2!1sen!2sin"
          width="300"
          height="300"
